...
export default function TrackerBox () {
  ...
  return (
    <div>
      <div className='mt-20'>
          <div className='text-2xl text-center'>Track and Trace Your Request</div>
        ...
        {
          notFound &&
            <div className='my-10 text-center text-gray-700'>No record matched to this reference code.</div>
        }
            ...
            (documentData) &&
              <>
                ...
                <div className='pl-4 mb-2'>
                  ...
                  <span className='font-bold text-sm'>{documentData.current_status} </span>
                </div>
