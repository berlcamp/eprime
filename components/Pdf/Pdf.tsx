...
import { ConfirmModal, CustomButton, Title } from '@/components/index'
            ...
            <div className="w-2/3">
              ...
              >
                ...
                <p className="text-sm text-gray-500">
                  Drag the scanned copy of your signed Position Description Form
                  (DBM CSC Form No.1) here. Or click to select file.
                </p>
              </div>
