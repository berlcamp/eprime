              ...
              <div className='flex flex-col md:flex-row items-start justify-start'>
                <div className='app__modal_menu'>
                  <ul>
                    ...
                    <li onClick={() => setActiveMenu('trainings')} className={`${activeMenu === 'trainings' ? 'app__modal_menu_link_active' : 'app__modal_menu_link'}`}>L&D Interventions/Trainings Attended</li>
