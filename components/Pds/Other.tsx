...
export default function Other ({ userId }: { userId: string }) {
  ...
  const [nonAcademicArray, setNonAcademicArray] = useState<NonAcademicRowTypes[] | []>([])
  const [membershipArray, setMembershipArray] = useState<MembershipRowTypes[] | []>([])

  const [showAddSkill, setShowAddSkill] = useState(false)
  const [showAddNonAcademic, setShowAddNonAcademic] = useState(false)
  const [showAddMembership, setShowAddMembership] = useState(false)

  const { register, formState: { errors }, reset, handleSubmit } = useForm<SkillsRowTypes>({
    mode: 'onSubmit'
  })

  const { register: register2, formState: { errors: errors2 }, reset: reset2, handleSubmit: handleSubmit2 } = useForm<NonAcademicRowTypes>({
    mode: 'onSubmit'
  })

  const { register: register3, formState: { errors: errors3 }, reset: reset3, handleSubmit: handleSubmit3 } = useForm<MembershipRowTypes>({
    mode: 'onSubmit'
  })

  const { register: register4, formState: { errors: errors4 }, handleSubmit: handleSubmit4 } = useForm<OtherInformationTypes>({
    mode: 'onSubmit'
  })
  ...
  const onSubmit = async (formdata: OtherInformationTypes) => {
    if (saving) return
    ...
    if (error) {
      void logError('Update Other information PDS', 'hrm_pds', JSON.stringify(newData), error.message)
          ...
          <div className="w-full">
            ...
            <div className='w-full px-4'>
              <div className="flex items-center">
                ...
                <div className="mx-4 my-4 text-gray-500 text-sm">Special Skills and Hobbies</div>
                <div className="flex-grow bg-gray-300 h-px"></div>
              </div>
              <div className='w-full'>
                {
                        ...
                        !showAddSkill
                          ...
                          : <div className='w-2/3 space-y-4'>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Special Skills and Hobbies:</div>
                                <input
                                  {...register('title', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.title && <div className='app__error_message'>Special Skills and Hobbies is required</div>}
                              </div>
            ...
            <div className='w-full px-4'>
              <div className="flex items-center">
                <div className="flex-grow bg-gray-300 h-px"></div>
                <div className="mx-4 my-4 text-gray-500 text-sm">NON-ACADEMIC DISTINCTIONS / RECOGNITION </div>
                <div className="flex-grow bg-gray-300 h-px"></div>
              </div>
              <div className='w-full'>
                {
                  nonAcademicArray.length > 0 &&
                    <table className='app__table mb-4'>
                      <thead className='app__thead'>
                        <tr>
                          <th className='app__th'>NON-ACADEMIC DISTINCTIONS / RECOGNITION </th>
                          <th className='app__th'></th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <form onSubmit={handleSubmit2(onSubmitNonAcademic)} className="text-xs">
                      {
                        !showAddNonAcademic
                          ...
                          : <div className='w-2/3 space-y-4'>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Non-Academic Distinction / Recognation <span className='text-gray-500 text-[11px]'>(Write in full)</span>:</div>
                                <input
                                  {...register2('title', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors2.title && <div className='app__error_message'>Non-Academic Distinction / Recognation is required</div>}
                              </div>
                              <div className='mb-2 w-full space-x-2'>
                                <CustomButton
                                  containerStyles='app__btn_green'
            ...
            <div className='w-full px-4'>
              <div className="flex items-center">
                <div className="flex-grow bg-gray-300 h-px"></div>
                <div className="mx-4 my-4 text-gray-500 text-sm">MEMBERSHIP IN ASSOCIATION/ORGANIZATION </div>
                <div className="flex-grow bg-gray-300 h-px"></div>
              </div>
              <div className='w-full'>
                {
                  membershipArray.length > 0 &&
                    <table className='app__table mb-4'>
                      <thead className='app__thead'>
                        <tr>
                          <th className='app__th'>MEMBERSHIP IN ASSOCIATION/ORGANIZATION </th>
                          <th className='app__th'></th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <form onSubmit={handleSubmit3(onSubmitMembership)} className="text-xs">
                      {
                        !showAddMembership
                          ...
                          : <div className='w-2/3 space-y-4'>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>MEMBERSHIP IN ASSOCIATION/ORGANIZATION <span className='text-gray-500 text-[11px]'>(Write in full)</span>:</div>
                                <input
                                  {...register3('title', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors3.title && <div className='app__error_message'>This is required</div>}
                              </div>
                              <div className='mb-2 w-full space-x-2'>
                                <CustomButton
                                  containerStyles='app__btn_green'
                ...
                <>
                  ...
                  <div className='w-full px-4'>
                    <div className='app__label_standard'>
                      ...
                      {errors4.confirmed && <div className='app__error_message'>Confirmation is required</div>}
                    </div>
                  </div>
