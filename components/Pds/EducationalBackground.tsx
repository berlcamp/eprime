...
export default function EducationalBackground ({ userId }: { userId: string }) {
  ...
  const { register: register2, formState: { errors: errors2 }, handleSubmit: handleSubmit2 } = useForm<EducationalBackgroundTypes>({
    mode: 'onSubmit'
  })
  ...
  const onSubmit = async (formdata: EducationalBackgroundTypes) => {
    if (saving) return
    ...
    if (error) {
      void logError('Update Educational Background', 'hrm_pds', JSON.stringify(newData), error.message)
          ...
          <div className="w-full">
            <div className='w-full px-4'>
              <div className="flex items-center">
                ...
                <div className="mx-4 my-4 text-gray-500 text-sm">Educational Background</div>
                <div className="flex-grow bg-gray-300 h-px"></div>
              </div>
              <div className='w-full'>
                {
                    ...
                    <table className='app__table mb-4'>
                      <thead className='app__thead'>
                        <tr>
                          ...
                          <th className='app__th'>Scholarship/Academic Honors Received</th>
                        ...
                        !showAddRow
                          ...
                          : <div className='w-2/3 space-y-4'>
                              <div className='mb-2 w-full'>
                                ...
                                {errors.level && <div className='app__error_message'>Level is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Name of School <span className='text-gray-500 text-[11px]'>(Write in full)</span>:</div>
                                <input
                                  {...register('school', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.school && <div className='app__error_message'>School Name is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Basic Education/Degree/Course <span className='text-gray-500 text-[11px]'>(Write in full)</span>:</div>
                                <input
                                  {...register('course', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.course && <div className='app__error_message'>Education/Degree/Course is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Period of Attendance (From):</div>
                                <input
                                  {...register('from', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.from && <div className='app__error_message'>Period of Attendance is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Period of Attendance (To):</div>
                                <input
                                  {...register('to', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.to && <div className='app__error_message'>Period of Attendance is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Highest Level/Units Earned <span className='text-gray-500 text-[11px]'>(if not graduated)</span>:</div>
                                <input
                              ...
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Year Graduated:</div>
                                <input
                                  {...register('year_graduated', { required: true })}
                                  type="text"
                                  className='app__input_standard'/>
                                {errors.year_graduated && <div className='app__error_message'>Year Graduated is required</div>}
                              </div>
                              <div className='mb-2 w-full'>
                                <div className='app__label_standard'>Scholarship/Academic Honors Received:</div>
                                <input
