...
export default function PersonalInfo ({ userId }: { userId: string }) {
  ...
  const [userData, setUserData] = useState<PdsPersonalInfomationTypes | null>(null)

  const { register, formState: { errors }, reset, handleSubmit } = useForm<PdsPersonalInfomationTypes>({
    mode: 'onSubmit'
  })
  ...
  const onSubmit = async (formdata: PdsPersonalInfomationTypes) => {
    ...
    if (error) {
      void logError('Update Pds Personal Info', 'hrm_pds', JSON.stringify(newData), error.message)
            ...
            <div className='flex flex-col lg:flex-row w-full items-start justify-between text-xs dark:text-gray-400'>
              ...
              <div className='w-full px-4'>
                <div className="flex items-center">
                  ...
                  <div className="mx-4 my-4 text-gray-500 text-sm">Personal Information</div>
                  <div className="flex-grow bg-gray-300 h-px"></div>
                </div>
                  ...
                  <div className='w-full'>
                    <div className='app__label_standard'>First Name:</div>
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.firstname}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.middlename}</div>
                        : <div>
                            <input
                              {...register('middlename')}
                              type="text"
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.place_of_birth}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.civil_status}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.blood_type}</div>
                        : <div>
                            <input
                              {...register('blood_type')}
                              type="text"
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.citizenship}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.telephone}</div>
                        : <div>
                            <input
                              {...register('telephone')}
                              type="text"
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.mobile_number}</div>
                        : <div>
                            <input
                ...
                <div className="flex items-center">
                  <div className="flex-grow bg-gray-300 h-px"></div>
                  <div className="mx-4 my-4 text-gray-500 text-sm">Government IDs</div>
                  <div className="flex-grow bg-gray-300 h-px"></div>
                </div>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.pagibig_no}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.philhealth_no}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.agency_employee_no}</div>
                        : <div>
                            <input
              ...
              <div className='w-full px-4'>
                <div className="flex items-center">
                  <div className="flex-grow bg-gray-300 h-px"></div>
                  <div className="mx-4 my-4 text-gray-500 text-sm">Residential Address</div>
                  <div className="flex-grow bg-gray-300 h-px"></div>
                </div>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_house_no}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_street}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    <div className='app__label_standard'>Subdivision/Village:</div>
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_subdivision}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_barangay}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_city}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_province}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.residential_zip}</div>
                        : <div>
                            <input
                ...
                <div className="flex items-center">
                  <div className="flex-grow bg-gray-300 h-px"></div>
                  <div className="mx-4 my-4 text-gray-500 text-sm">Permanent Address</div>
                  <div className="flex-grow bg-gray-300 h-px"></div>
                </div>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_house_no}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_street}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_subdivision}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_barangay}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_city}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_province}</div>
                        : <div>
                            <input
                ...
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    {
                      userId !== session.user.id
                        ? <div className='app__label_value'>{userData?.permanent_zip}</div>
                        : <div>
                            <input
