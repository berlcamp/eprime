      ...
      <div className="app__modal_wrapper2">
        <div className="app__modal_wrapper3">
          <div className="app__modal_header">
            <h5 className="app__modal_header_text">Confirm Delete Account</h5>
          </div>
          <div className="modal-body relative p-4">
            <div className="grid grid-cols-1 gap-4 mb-4">
              <div className="w-full">
                <div className="text-gray-600 text-sm mb-1 dark:text-gray-300">
                  Confirm deletion of this account by typing 'delete' below:
                </div>
                <div>
                  <input
            ...
            <div className="app__modal_footer">
              <button
                ...
                onClick={onConfirm}
                type="button"
                className={btnDisabled ? 'app__btn_gray' : 'app__btn_red'}
              >
                Confirm Delete
              </button>
              <button
