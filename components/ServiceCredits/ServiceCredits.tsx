...
export default function ServiceCredits ({ userId }: { userId: string }) {
  ...
  const handleShowMore = async () => {
    ...
    try {
      const result = await fetchMyServiceCredits({ userId }, perPageCount, list.length)
  ...
  return (
    ...
    <div>
        ...
        <div className='app__warning_text'><span className='app__warning_title'>Note:</span> Employee need to provide supporting documents as basis for approval.</div>
