    ...
    <>
      <div>
        ...
        <div className="app__warning_text">
          ...
          provide supporting documents as basis for Promotion approval.
        </div>
          ...
          <table className="app__table">
            <thead className="app__thead">
              <tr>
                ...
                <th className="hidden md:table-cell app__th">Employee</th>
                <th className="hidden md:table-cell app__th">New Position</th>
            ...
            <tbody>
              {!isDataEmpty &&
                list.map((item: PromotionTypes, index) => (
                        ...
                        <div className="md:hidden app__td_mobile">
                          ...
                          <div>
                            ...
                            {item.effectivity_date &&
                              format(
                                new Date(item.effectivity_date),
                                'MMM d, yyyy'
                              )}
                          </div>
                          <div>
                            ...
                            {item.status === 'For Final Approval' && (
                              <span className="app__status_container_orange">
                                For Final Approval
                              </span>
                            )}
