...
export default function RatingsModal({
  ...
  const handleUpdateObjectives = (updatedObjective: IpcrfObjectiveTypes) => {
    const updatedObjectives = objectives.map((item) => {
      if (item.id === updatedObjective.id) {
        return {
          ...item,
          cot_1_rating: updatedObjective.cot_1_rating,
          cot_2_rating: updatedObjective.cot_2_rating,
          cot_3_rating: updatedObjective.cot_3_rating,
          cot_4_rating: updatedObjective.cot_4_rating,
            ...
            <div className="modal-body relative p-4 overflow-x-scroll">
                ...
                <table className="w-full text-sm text-left text-gray-600 dark:text-gray-400">
                  <thead className="text-xs border-b uppercase bg-gray-100 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                      ...
                      <th className="py-2 px-2 text-center">COT&nbsp;1</th>
                      <th className="py-2 px-2 text-center">COT&nbsp;2</th>
                      <th className="py-2 px-2 text-center">COT&nbsp;3</th>
                      <th className="py-2 px-2 text-center">COT&nbsp;4</th>
              ...
              <div className="flex items-center justify-end space-x-2 my-2">
                ...
                <div className="font-bold text-emerald-700">
                  {objectives && getTotalScore()}
                </div>
              </div>
              <div className="flex items-center justify-end space-x-2 my-2">
                <div className="font-bold">Adjectival Rating:</div>
                <div className="font-bold text-emerald-700">
                  {objectives && getAdjectivalRating()}
                </div>
              </div>
              <div className="flex items-center justify-end space-x-2 my-2">
