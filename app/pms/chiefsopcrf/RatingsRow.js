...
export default function RatingsRow ({ item, status, view, updateObjectives }) {
  ...
  return (
    <tr
      ...
      <td className="px-2 py-2 align-top">
        <div>{item.title}</div>
        <div className='mt-4'><b>MOV:</b> {item.mov}
          <div className='mt-4'>
      ...
      <td className="px-2 py-2 align-top text-center">
        ...
        {
          (status === 'Approved' || view === 'as_approver') && efficiency
        }
      </td>
      <td className="px-2 py-2 align-top text-center">
        {
        ...
        {
          (status === 'Approved' || view === 'as_approver') && timeliness
        }
      </td>
      <td className="px-2 py-2 align-top text-center">
        {item.score}
