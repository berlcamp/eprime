                ...
                <div className='app__label_standard'>
                  <label className='flex items-center space-x-2'>
                    <input
                      ...
                      type='checkbox'
                      className=''/>
                    <span className='font-normal text-xs'>By checking this, you agree that the details are correct. After revoking, this designation can no longer be edited.</span>
                  </label>
