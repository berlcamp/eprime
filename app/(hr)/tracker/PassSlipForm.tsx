...
// Types
import type { Employee, PassSlipTypes, namesType } from '@/types'
...
const PassSlipForm = ({ hideModal }: ModalProps) => {
  ...
  const { register, formState: { errors }, reset, handleSubmit } = useForm<PassSlipTypes>({
    mode: 'onSubmit'
  })
      ...
      <form onSubmit={handleSubmit(onSubmit)} className=''>
        <div className='flex flex-col lg:flex-row w-full items-start justify-between text-xs dark:text-gray-400'>
          ...
          <div className='w-full px-4'>
                ...
                <div>
                  <select
                    ...
                    className='app__select_standard'>
                      ...
                      <option value='Leave the office premises during office hours'>Leave the office premises during office hours</option>
                      <option value='Deviate from my fixed time of arrival (Fixed Time)'>Deviate from my fixed time of arrival (Fixed Time)</option>
                  </select>
            ...
            {
              passSlipType === 'Leave the office premises during office hours' &&
                <>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    <div className='app__label_standard'>Intended time of arrival</div>
                    <div>
                      <input
                        {...register('intended_time_arrival', { required: true })}
                        type='text'
                        placeholder='Intended time of arrival'
                        className='app__input_standard'/>
                      {errors.intended_time_arrival && <div className='app__error_message'>Intended time of arrival is required</div>}
                    </div>
                  </div>
                </div>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    <div className='app__label_standard'>Intended time of departure</div>
                    <div>
                      <input
                        {...register('intended_time_departure', { required: true })}
                        type='text'
                        placeholder='Intended time of departure'
                        className='app__input_standard'/>
                      {errors.intended_time_departure && <div className='app__error_message'>Intended time of departure is required</div>}
                    </div>
                  </div>
                </div>
                </>
            ...
            {
              passSlipType === 'Deviate from my fixed time of arrival (Fixed Time)' &&
                <>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    <div>
                      <input
                        ...
                        className='app__input_standard'/>
                      {errors.fixed_time_from && <div className='app__error_message'>This field is required</div>}
                    </div>
                  </div>
                </div>
                <div className='app__form_field_container'>
                  <div className='w-full'>
                    ...
                    <div>
                      <input
                        ...
                        placeholder='To'
                        className='app__input_standard'/>
                      {errors.fixed_time_to && <div className='app__error_message'>This field is required</div>}
                    </div>
                  </div>
                </div>
                </>
            ...
            <div className='app__form_field_container'>
              <div className='w-full'>
                ...
                <div>
                  ...
                  {errors.purpose && <div className='app__error_message'>Purpose is required</div>}
                </div>
              </div>
            </div>
            <div className='app__form_field_container'>
              <div className='w-full'>
                ...
                <div>
                  <input
                    ...
                    placeholder='Reason'
                    className='app__select_standard'/>
                  {errors.reason && <div className='app__error_message'>Reason is required</div>}
                </div>
              </div>
            </div>
          </div>
