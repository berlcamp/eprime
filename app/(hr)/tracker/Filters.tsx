...
const Filters = ({ setFilterKeyword, setFilterType, setFilterStatus, setFilterRequester }: PropTypes) => {
  ...
  const handleApply = () => {
    if (keyword.trim() === '' && status.trim() === '' && type.trim() === '' && selectedRequesterId === '') return
  ...
  return (
    <div className=''>
      <div className='items-center space-y-2 space-x-1'>
        <form onSubmit={handleSubmit} className='inline-flex items-center app__filter_field_container'>
