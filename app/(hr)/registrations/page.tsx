...
const Page: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const result = await fetchRegistrations({ filterKeyword, filterSchool, filterOffice }, perPageCount, 0)
  ...
  const handleShowMore = async () => {
    ...
    try {
      const result = await fetchRegistrations({ filterKeyword, filterSchool, filterOffice }, perPageCount, list.length)
                              ...
                              item.status === 'For Approval' &&
                                <div className='flex items-center justify-start space-x-2'>
                                  <CustomButton
                                    ...
                                    title='Approve'
                                    btnType='button'
                                    handleClick={async () => await handleApprove(item)}
                                  />
                                  <CustomButton
