...
>((props, ref) => {
  ...
  const computed = React.useMemo(() => {
    ...
    const stepIncrement =
      (Number(selectedItem.new_step) || 0) -
      (Number(selectedItem.previous_step) || 0);
  ...
  return (
    <div className="invisible print:visible">
      ...
      <div
        ref={ref}
        className={`print-nosi-container w-[${CONTENT_WIDTH}px] max-w-full bg-white py-2 px-[10mm] min-h-0`}
      ...
      >
          ...
          <tbody>
            ...
            <tr>
              <td className="py-1 align-top">
                <div>2. Add: {computed.stepIncrement} Step Increment</div>
        ...
        <div className="indent-8 mt-4 text-sm text-justify">
          The salary adjustment is subject to review and post-audit, and to
...
PrintNosi.displayName = "PrintNosi";
