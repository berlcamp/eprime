        ...
        {!loading && userData && (
          <>
            <div className="px-2 mt-12">
              ...
              <div className="text-center mt-1 capitalize text-xs text-gray-400">
                {userData.hrm_positions?.name}
              </div>
              {userData.hrm_designations?.length > 0 ? (
                <>
                  {userData.hrm_designations.map(
                ...
                <div className="text-center mt-2 capitalize text-xs text-gray-300">
                  {userData.hrm_schools?.name} {userData.hrm_offices?.name}
                </div>
              )}
              {/* Menu */}
              <ul className="pt-8 mt-4 space-y-2 border-gray-700">
                ...
                <li>
                  <Link
                    ...
                    className={`app__profile_menu_link ${
                      page === 'requests' ? 'bg-gray-700' : ''
                    }`}
                  >
                    <span className="flex-1 ml-3 whitespace-nowrap">
                      Requests (Leave, Travel, etc)
                    </span>
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link
                    ...
                    className={`app__profile_menu_link ${
                      page === 'servicecredits' ? 'bg-gray-700' : ''
                    }`}
                  >
                    <span className="flex-1 ml-3 whitespace-nowrap">
                      Service Credits
                ...
                <li>
                  <Link
                    ...
                    className={`app__profile_menu_link ${
                      page === 'servicerecords' ? 'bg-gray-700' : ''
                    }`}
                  >
                    <span className="flex-1 ml-3 whitespace-nowrap">
                      Service Records
